...
ENTITIES = [
    "时间", "民航", "运输周转量", "旅客周转量", "货邮周转量", "国内航线", "国际航线", "港澳台航线", "幅度", "对比率", "值", "旅客运输量", "货邮运输量", "旅客吞吐量",
    "货邮吞吐量", "起降架次", "超万", "航空作业", "经营许可证", "地区",
    "地区协定", "平均利用率", "运输机场", "运输飞机", "在册运输飞机", "颁证运输机场", "期末在册航空器", "训练飞机", "新增机场", "迁建", "停航", "跑道", "停机位", "航楼面积",
    "定期航班", "国际通航", "内地城市", "国际城市", "公司", "飞行时间",
    "航空作业", "无人机注册用户", "个人用户", "单位用户", "无人机驾驶执照", "无人机", "正班客座率", "正班载运率", "营业收入", "利润总额", "运输收入水平", "客运收入水平", "货邮收入水平",
    "客公里收入水平", "航空安全", "事故征候", "严重事故征候", "通用航空事故征候", "人为责任事故征候", "严重事故征候万时率",
    "万时率", "运输航空", "安全飞行时间", "民航安检部门", "旅客", "托运行李", "航空货物", "快件", "旅客行为", "非法事件", "安保事件", "计划航班", "正常航班", "不正常航班",
    "正常执行", "航班正常率", "航班", "服务质量", "平均延误时间", "组织",
    "消费者投诉", "受理投诉总量", "有效投诉量", "服务满意度", "固定资产投资", "基本建设和技术改造投资", "重点建设项目", "竣工项目", "工程", "续建项目", "新开项目", "进行中项目", "系统",
    "社会责任", "应急保障赴海外紧急撤侨任务", "抢险救灾任务", "重大运输任务", "上缴税金", "临时航线", "飞行距离",
    "航油消耗", "二氧化碳排放", "桥载设备", "资金", "工作", "驾驶执照飞行人员", "民航直属院校", "招收学生", "学生", "特有专业", "科技成果", "奖项", "在校生数", "毕业学生",
    "占比例", "民航工会", "竞赛", "单位", "班组", "职工",
    "先进集体", "个人", "规章", "规章手册", "民航工会", "领军人才", "拔尖人才", "创新团队", "民航科学院基地", "驾驶员有效执照", "装备", "系统人员", "磋商会谈", "适航文件",
    "航空器", "证件", "证件类型", "车辆", "设施", "发电",
